...
# FONTS
roboto_big = pygame.font.SysFont("Roboto", 140)
roboto_small = pygame.font.SysFont("Roboto", 25)
...
while 1:
    if game_over:
        ...
        game_over_text_rect = game_over_text.get_rect(center=(screen_width // 2, screen_height // 2 - 25))
        score_text = roboto_small.render(f"Score: {score}", False, white)
        score_text_rect = score_text.get_rect(center=(screen_width // 2, screen_height // 2 + 65))
        score = 0
