...
# FONTS
roboto_big = pygame.font.Font("media/fonts/Roboto-Regular.ttf", 130)
roboto_small = pygame.font.Font("media/fonts/Roboto-Regular.ttf", 25)

# SOUNDS
# explosion_sound = pygame.mixer.Sound("media/sounds/explosion.mp3")
# laser_sound = pygame.mixer.Sound("media/sounds/laser_gun.mp3")
# bgm = pygame.mixer.Sound("media/sounds/bgm.mp3")
# bgm.play(loops=-1)
# bgm.set_volume(0.8)
...
class Player(pygame.sprite.Sprite):
    ...
    def draw_energy(self):  # Draw Energy
        pygame.draw.rect(screen, yellow, (10, 15, self.energy, 30))
        pygame.draw.rect(screen, gray, (10, 15, 200, 30), 2)
    ...
    def draw_health(self):  # Draw Health
        ...
        screen.blit(health_text, (70,50))

    def draw_score(self):
        pygame.draw.rect(screen, white, (560, 10, 200, 30))
        pygame.draw.rect(screen, gray, (560, 10, 200, 30), 2)
        score_text = roboto_small.render(f"Score: {score}", False, gray)
...
# GAME LOOP
async def main():
    global clock, fps, dt, time_baseline, score, white, gray, black, red, yellow, time, current_spawn_index, spawn_order, spawn_delay, double_chance, triple_chance, time_baseline, game_retry, last_spawn_time
    game_over = False
    game_retry = False
    while 1:
        if game_over:
            ...
            score_text = roboto_small.render(f"Score: {score}", False, white)
            score_text_rect = score_text.get_rect(center=(screen_width // 2, screen_height // 2 + 70))
            score = 0
